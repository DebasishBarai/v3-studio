...
3. Angle images will be generated using the main scene as a reference + angleVideoPrompt
4. Videos will be created by animating these images with camera motion and subtle movements
5. All clips will be edited together to create the final video
...
- **angles**: (OPTIONAL array) Additional camera perspectives of the SAME scene/moment
  ...
  - **angleVideoPrompt**: Detailed description (80-150 words) of the alternative angle. Must include:
...
**CRITICAL**: Angle prompts will use the main scene image as a reference, so focus on what's DIFFERENT about the angle.

## Critical Guidelines

1. **Visual Clarity**: Every prompt should create a clear mental image that AI can accurately generate
2. **Consistency**: Characters/subjects must look identical across all scenes - always reference the character descriptions
3. **Appropriate Animation**: Consider what movements are natural for the style (subtle for realistic, more dynamic for animated)
4. **Camera Language**: Use professional cinematography terms appropriate for the style
5. **Atmospheric Details**: Include lighting, mood, and environmental details
6. **Location Logic**: Maintain consistent environmental details when scenes share locations
7. **Story Flow**: Scenes should progress logically and tell a coherent narrative
8. **Angle Purpose**: Each angle should add value - better detail, emotional impact, or visual variety
