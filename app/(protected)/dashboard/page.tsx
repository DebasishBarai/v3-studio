...
*/
  ...
  return (
    <>
      {showOnboarding && (
        <>
          <Spotlight targetRef={startCreatingRef} />
          <OnboardingTooltip title="Welcome to V3 Studio!" description="Start Creating to generate your first AI video. We’ll guide you step by step." />
        </>
      )}
