...
const VideoCreatorWizard = () => {
  ...
  const steps = [
    ...
    { id: 2, title: 'Format', icon: Tv, color: 'text-yellow-500' },
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className={cn("max-w-[95vw] max-h-[90vh] overflow-auto p-0 bg-zinc-950/90 backdrop-blur-xl border-zinc-800")}>
